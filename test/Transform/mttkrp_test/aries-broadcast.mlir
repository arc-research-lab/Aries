// RUN: aries-opt -aries-broadcast-detect %s | FileCheck %s
...
// CHECK:                       adf.dma.broadcast(%arg0[%32, %33, %36] [%c2, %c8, %c16] [%c1, %c1, %c1] [] [] [] [], {%4, %12} [] [] [] [] [] [] []) : (memref<8x32x128xf32>, memref<2x8x16xf32, 2>, memref<2x8x16xf32, 2>)
// CHECK:                       adf.dma.broadcast(%arg2[%36, %35] [%c16, %c16] [%c1, %c1] [] [] [] [], {%6, %22} [] [] [] [] [] [] []) : (memref<128x128xf32>, memref<16x16xf32, 2>, memref<16x16xf32, 2>)
...
// CHECK:                       adf.dma.broadcast(%arg1[%33, %37] [%c8, %c16] [%c1, %c1] [] [] [] [], {%9, %13, %25, %29} [] [] [] [] [] [] []) : (memref<32x128xf32>, memref<8x16xf32, 2>, memref<8x16xf32, 2>, memref<8x16xf32, 2>, memref<8x16xf32, 2>)
// CHECK:                       adf.dma.broadcast(%arg2[%34, %37] [%c16, %c16] [%c1, %c1] [] [] [] [], {%10, %26} [] [] [] [] [] [] []) : (memref<128x128xf32>, memref<16x16xf32, 2>, memref<16x16xf32, 2>)
...
// CHECK:                       adf.dma.broadcast(%arg2[%36, %37] [%c16, %c16] [%c1, %c1] [] [] [] [], {%14, %30} [] [] [] [] [] [] []) : (memref<128x128xf32>, memref<16x16xf32, 2>, memref<16x16xf32, 2>)
...
// CHECK:                       adf.dma.broadcast(%arg0[%38, %33, %34] [%c2, %c8, %c16] [%c1, %c1, %c1] [] [] [] [], {%16, %24} [] [] [] [] [] [] []) : (memref<8x32x128xf32>, memref<2x8x16xf32, 2>, memref<2x8x16xf32, 2>)
...
// CHECK:                       adf.dma.broadcast(%arg0[%38, %33, %36] [%c2, %c8, %c16] [%c1, %c1, %c1] [] [] [] [], {%20, %28} [] [] [] [] [] [] []) : (memref<8x32x128xf32>, memref<2x8x16xf32, 2>, memref<2x8x16xf32, 2>)
