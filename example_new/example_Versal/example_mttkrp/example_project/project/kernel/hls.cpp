            ...
            for (int v106 = 0; v106 < 16; v106++) {	// L276
              for (int v107 = 0; v107 < 2; v107++) {	// L277
                ...
                #pragma HLS pipeline II=1
                  ...
                  if (v110) {	// L281
                    v98.write(v109); //v98                    v98 = v109;	// L282
                  } else {
                    v97.write(v109); //v97                    v97 = v109;	// L284
                  }
                }
              }
            }
            ...
            for (int v112 = 0; v112 < 16; v112++) {	// L291
              for (int v113 = 0; v113 < 2; v113++) {	// L292
                ...
                #pragma HLS pipeline II=1
                  ...
                  if (v116) {	// L296
                    v100.write(v115); //v100                    v100 = v115;	// L297
                  } else {
                    v99.write(v115); //v99                    v99 = v115;	// L299
                  }
                }
              }
            }
            ...
            for (int v318 = 0; v318 < 2; v318++) {	// L631
              for (int v319 = 0; v319 < 2; v319++) {	// L632
                ...
                #pragma HLS pipeline II=1
                  ...
                  ap_int<512> v322;
                  if (v321) {	// L635
                    ap_int<512> v323 = v310.read(); //v310                    v323 = v310;	// L636
                    v322 = v323;	// L637
                  } else {
                    ap_int<512> v324 = v309.read(); //v309                    v324 = v309;	// L639
                    v322 = v324;	// L640
                  }
            ...
            for (int v326 = 0; v326 < 2; v326++) {	// L648
              for (int v327 = 0; v327 < 2; v327++) {	// L649
                ...
                #pragma HLS pipeline II=1
                  ...
                  ap_int<512> v330;
                  if (v329) {	// L652
                    ap_int<512> v331 = v311.read(); //v311                    v331 = v311;	// L653
                    v330 = v331;	// L654
                  } else {
                    ap_int<512> v332 = v312.read(); //v312                    v332 = v312;	// L656
                    v330 = v332;	// L657
                  }
                ...
                for (int v350 = 0; v350 < 8; v350++) {	// L683
                  for (int v351 = 0; v351 < 2; v351++) {	// L684
                    ...
                    #pragma HLS pipeline II=1
                      ...
                      if (v354) {	// L688
                        v340.write(v353); //v340                        v340 = v353;	// L689
                      } else {
                        v339.write(v353); //v339                        v339 = v353;	// L691
                      }
                    }
                  }
                }
                ...
                for (int v358 = 0; v358 < 8; v358++) {	// L702
                  for (int v359 = 0; v359 < 2; v359++) {	// L703
                    ...
                    #pragma HLS pipeline II=1
                      ...
                      if (v362) {	// L707
                        v341.write(v361); //v341                        v341 = v361;	// L708
                      } else {
                        v342.write(v361); //v342                        v342 = v361;	// L710
                      }
                    }
                  }
                }
...
void mttkrp_pl(
  ...
  send3_top(v443, v456, v442, v451, v445, v450, v433, v459);	// L881
  load2_top(v430, v473, v475, v472, v474);	// L882
  load2_3_top(v475, v457, v474, v455, v473, v453, v472, v452);	// L883
  send5_top(v438, v454, v434, v458);	// L884
  receive2_top(v436, v448, v441, v446, v444, v449, v432, v447);	// L885
  send6_top(v440, v453, v435, v455, v437, v452, v439, v457);	// L886
  store0_0_top(v446, v476, v447, v477, v448, v478, v449, v479);	// L887
  store0_top(v431, v479, v478, v476, v477);	// L888
  load0_top(v428, v482, v483, v481, v480);	// L889
