...
module {
  func.func @kernel_mttkrp0(%arg0: memref<2x8x16xi32, 2>, %arg1: memref<8x16xi32, 2>, %arg2: memref<16x16xi32, 2>) -> memref<2x16xi32, 2> attributes {adf.kernel, edge_kernel} {
    %c0_i32 = arith.constant 0 : i32
    %alloc = memref.alloc() : memref<2x16xi32, 2>
    affine.for %arg3 = 0 to 2 {
      affine.for %arg4 = 0 to 16 {
        affine.store %c0_i32, %alloc[%arg3, %arg4] : memref<2x16xi32, 2>
      }
    }
    affine.for %arg3 = 0 to 2 {
      affine.for %arg4 = 0 to 16 {
        ...
        affine.for %arg5 = 0 to 8 {
          affine.for %arg6 = 0 to 16 {
            %0 = affine.load %arg0[%arg3, %arg5, %arg6] : memref<2x8x16xi32, 2>
            %1 = affine.load %arg1[%arg5, %arg4] : memref<8x16xi32, 2>
            %2 = arith.muli %0, %1 : i32
            %3 = affine.load %arg2[%arg6, %arg4] : memref<16x16xi32, 2>
            %4 = arith.muli %2, %3 : i32
            %5 = affine.load %alloc[%arg3, %arg4] : memref<2x16xi32, 2>
            %6 = arith.addi %5, %4 : i32
            affine.store %6, %alloc[%arg3, %arg4] : memref<2x16xi32, 2>
          }
        }
      }
    }
    return %alloc : memref<2x16xi32, 2>
  }
  func.func @kernel_mttkrp(%arg0: memref<2x8x16xi32, 2>, %arg1: memref<8x16xi32, 2>, %arg2: memref<16x16xi32, 2>, %arg3: memref<2x16xi32, 2>) -> memref<2x16xi32, 2> attributes {adf.kernel} {
    %c0_i32 = arith.constant 0 : i32
    %alloc = memref.alloc() : memref<2x16xi32, 2>
    affine.for %arg4 = 0 to 2 {
      affine.for %arg5 = 0 to 16 {
        %0 = affine.load %arg3[%arg4, %arg5] : memref<2x16xi32, 2>
        affine.store %0, %alloc[%arg4, %arg5] : memref<2x16xi32, 2>
        affine.store %c0_i32, %alloc[%arg4, %arg5] : memref<2x16xi32, 2>
        affine.for %arg6 = 0 to 8 {
          affine.for %arg7 = 0 to 16 {
            %1 = affine.load %arg0[%arg4, %arg6, %arg7] : memref<2x8x16xi32, 2>
            %2 = affine.load %arg1[%arg6, %arg5] : memref<8x16xi32, 2>
            %3 = arith.muli %1, %2 : i32
            %4 = affine.load %arg2[%arg7, %arg5] : memref<16x16xi32, 2>
            %5 = arith.muli %3, %4 : i32
            %6 = affine.load %alloc[%arg4, %arg5] : memref<2x16xi32, 2>
            %7 = arith.addi %6, %5 : i32
            affine.store %7, %alloc[%arg4, %arg5] : memref<2x16xi32, 2>
          }
        }
      }
    }
  ...
  func.func @adf_cell0(%arg0: !adf.plio<In, 128>, %arg1: !adf.plio<In, 128>, %arg2: !adf.plio<In, 128>, %arg3: !adf.plio<In, 128>, %arg4: !adf.plio<In, 128>, %arg5: !adf.plio<Out, 128>, %arg6: !adf.plio<In, 128>, %arg7: !adf.plio<In, 128>, %arg8: !adf.plio<In, 128>, %arg9: !adf.plio<Out, 128>, %arg10: !adf.plio<In, 128>, %arg11: !adf.plio<In, 128>, %arg12: !adf.plio<Out, 128>, %arg13: !adf.plio<Out, 128>) attributes {adf.cell, tripCount = [2 : index, 2 : index, 2 : index]} {
    ...
    %3 = adf.buffer.create @L1_L1_A_1() : memref<2x8x16xi32, 2>
    %4 = adf.buffer.create @L1_L1_B_1() : memref<8x16xi32, 2>
    %5 = adf.buffer.create @L1_L1_C_1() : memref<16x16xi32, 2>
    %6 = adf.buffer.create @L1_L1_D_1() {accumulator} : memref<2x16xi32, 2>
    %7 = adf.buffer.create @L1_L1_A_2() : memref<2x8x16xi32, 2>
    %8 = adf.buffer.create @L1_L1_B_2() : memref<8x16xi32, 2>
    %9 = adf.buffer.create @L1_L1_C_2() : memref<16x16xi32, 2>
    %10 = adf.buffer.create @L1_L1_A_3() : memref<2x8x16xi32, 2>
    %11 = adf.buffer.create @L1_L1_B_3() : memref<8x16xi32, 2>
    %12 = adf.buffer.create @L1_L1_C_3() : memref<16x16xi32, 2>
    %13 = adf.buffer.create @L1_L1_D_3() {accumulator} : memref<2x16xi32, 2>
    %14 = adf.buffer.create @L1_L1_A_4() : memref<2x8x16xi32, 2>
    %15 = adf.buffer.create @L1_L1_B_4() : memref<8x16xi32, 2>
    %16 = adf.buffer.create @L1_L1_C_4() : memref<16x16xi32, 2>
    %17 = adf.buffer.create @L1_L1_A_5() : memref<2x8x16xi32, 2>
    %18 = adf.buffer.create @L1_L1_B_5() : memref<8x16xi32, 2>
    %19 = adf.buffer.create @L1_L1_C_5() : memref<16x16xi32, 2>
    %20 = adf.buffer.create @L1_L1_D_5() {accumulator} : memref<2x16xi32, 2>
    %21 = adf.buffer.create @L1_L1_A_6() : memref<2x8x16xi32, 2>
    %22 = adf.buffer.create @L1_L1_B_6() : memref<8x16xi32, 2>
    %23 = adf.buffer.create @L1_L1_C_6() : memref<16x16xi32, 2>
    %24 = adf.buffer.create @L1_L1_A_7() : memref<2x8x16xi32, 2>
    %25 = adf.buffer.create @L1_L1_B_7() : memref<8x16xi32, 2>
    %26 = adf.buffer.create @L1_L1_C_7() : memref<16x16xi32, 2>
    %27 = adf.buffer.create @L1_L1_D_7() {accumulator} : memref<2x16xi32, 2>
    adf.connect(%arg0, %0) : (!adf.plio<In, 128>, memref<2x8x16xi32, 2>)
    adf.connect(%arg0, %7) : (!adf.plio<In, 128>, memref<2x8x16xi32, 2>)
    adf.connect(%arg1, %1) : (!adf.plio<In, 128>, memref<8x16xi32, 2>)
    adf.connect(%arg1, %4) : (!adf.plio<In, 128>, memref<8x16xi32, 2>)
    adf.connect(%arg1, %15) : (!adf.plio<In, 128>, memref<8x16xi32, 2>)
    adf.connect(%arg1, %18) : (!adf.plio<In, 128>, memref<8x16xi32, 2>)
    adf.connect(%arg2, %2) : (!adf.plio<In, 128>, memref<16x16xi32, 2>)
    adf.connect(%arg2, %16) : (!adf.plio<In, 128>, memref<16x16xi32, 2>)
    %28 = call @kernel_mttkrp0(%0, %1, %2) {adf.kernel, "col, row" = [24 : index, 0 : index], ivs = [0 : index, 0 : index, 0 : index], kernel = 0 : index, kernel_mttkrp0 = 0 : index} : (memref<2x8x16xi32, 2>, memref<8x16xi32, 2>, memref<16x16xi32, 2>) -> memref<2x16xi32, 2>
    adf.buffer.location(%28, %c24, %c0, %c16384, %c24576) : (memref<2x16xi32, 2>, index, index, index, index)
    adf.buffer.location(%1, %c24, %c0, %c0, %c8192) : (memref<8x16xi32, 2>, index, index, index, index)
    adf.buffer.location(%2, %c24, %c1, %c16384, %c24576) : (memref<16x16xi32, 2>, index, index, index, index)
    adf.buffer.location(%0, %c24, %c1, %c0, %c8192) : (memref<2x8x16xi32, 2>, index, index, index, index)
    adf.connect(%28, %6) : (memref<2x16xi32, 2>, memref<2x16xi32, 2>)
    adf.connect(%arg3, %3) : (!adf.plio<In, 128>, memref<2x8x16xi32, 2>)
    adf.connect(%arg3, %10) : (!adf.plio<In, 128>, memref<2x8x16xi32, 2>)
    adf.connect(%arg4, %5) : (!adf.plio<In, 128>, memref<16x16xi32, 2>)
    adf.connect(%arg4, %19) : (!adf.plio<In, 128>, memref<16x16xi32, 2>)
    %29 = call @kernel_mttkrp(%3, %4, %5, %6) {adf.kernel, "col, row" = [24 : index, 1 : index], ivs = [1 : index, 0 : index, 0 : index], kernel_mttkrp = 1 : index} : (memref<2x8x16xi32, 2>, memref<8x16xi32, 2>, memref<16x16xi32, 2>, memref<2x16xi32, 2>) -> memref<2x16xi32, 2>
    adf.buffer.location(%29, %c25, %c1, %c4096, %c12288) : (memref<2x16xi32, 2>, index, index, index, index)
    adf.buffer.location(%4, %c25, %c1, %c16384, %c24576) : (memref<8x16xi32, 2>, index, index, index, index)
    adf.buffer.location(%5, %c25, %c1, %c0, %c8192) : (memref<16x16xi32, 2>, index, index, index, index)
    adf.buffer.location(%3, %c24, %c0, %c4096, %c12288) : (memref<2x8x16xi32, 2>, index, index, index, index)
    adf.connect(%29, %arg5) : (memref<2x16xi32, 2>, !adf.plio<Out, 128>)
    adf.connect(%arg6, %8) : (!adf.plio<In, 128>, memref<8x16xi32, 2>)
    adf.connect(%arg6, %11) : (!adf.plio<In, 128>, memref<8x16xi32, 2>)
    adf.connect(%arg6, %22) : (!adf.plio<In, 128>, memref<8x16xi32, 2>)
    adf.connect(%arg6, %25) : (!adf.plio<In, 128>, memref<8x16xi32, 2>)
    adf.connect(%arg7, %9) : (!adf.plio<In, 128>, memref<16x16xi32, 2>)
    adf.connect(%arg7, %23) : (!adf.plio<In, 128>, memref<16x16xi32, 2>)
    %30 = call @kernel_mttkrp0(%7, %8, %9) {adf.kernel, "col, row" = [24 : index, 4 : index], ivs = [0 : index, 1 : index, 0 : index], kernel = 0 : index, kernel_mttkrp0 = 2 : index} : (memref<2x8x16xi32, 2>, memref<8x16xi32, 2>, memref<16x16xi32, 2>) -> memref<2x16xi32, 2>
    adf.buffer.location(%30, %c24, %c4, %c16384, %c24576) : (memref<2x16xi32, 2>, index, index, index, index)
    adf.buffer.location(%8, %c24, %c4, %c0, %c8192) : (memref<8x16xi32, 2>, index, index, index, index)
    adf.buffer.location(%9, %c24, %c5, %c16384, %c24576) : (memref<16x16xi32, 2>, index, index, index, index)
    adf.buffer.location(%7, %c24, %c5, %c0, %c8192) : (memref<2x8x16xi32, 2>, index, index, index, index)
    adf.connect(%30, %13) : (memref<2x16xi32, 2>, memref<2x16xi32, 2>)
    adf.connect(%arg8, %12) : (!adf.plio<In, 128>, memref<16x16xi32, 2>)
    adf.connect(%arg8, %26) : (!adf.plio<In, 128>, memref<16x16xi32, 2>)
    %31 = call @kernel_mttkrp(%10, %11, %12, %13) {adf.kernel, "col, row" = [24 : index, 5 : index], ivs = [1 : index, 1 : index, 0 : index], kernel_mttkrp = 3 : index} : (memref<2x8x16xi32, 2>, memref<8x16xi32, 2>, memref<16x16xi32, 2>, memref<2x16xi32, 2>) -> memref<2x16xi32, 2>
    adf.buffer.location(%31, %c25, %c5, %c4096, %c12288) : (memref<2x16xi32, 2>, index, index, index, index)
    adf.buffer.location(%11, %c25, %c5, %c16384, %c24576) : (memref<8x16xi32, 2>, index, index, index, index)
    adf.buffer.location(%12, %c25, %c5, %c0, %c8192) : (memref<16x16xi32, 2>, index, index, index, index)
    adf.buffer.location(%10, %c24, %c4, %c4096, %c12288) : (memref<2x8x16xi32, 2>, index, index, index, index)
    adf.connect(%31, %arg9) : (memref<2x16xi32, 2>, !adf.plio<Out, 128>)
    adf.connect(%arg10, %14) : (!adf.plio<In, 128>, memref<2x8x16xi32, 2>)
    adf.connect(%arg10, %21) : (!adf.plio<In, 128>, memref<2x8x16xi32, 2>)
    %32 = call @kernel_mttkrp0(%14, %15, %16) {adf.kernel, "col, row" = [24 : index, 2 : index], ivs = [0 : index, 0 : index, 1 : index], kernel = 0 : index, kernel_mttkrp0 = 4 : index} : (memref<2x8x16xi32, 2>, memref<8x16xi32, 2>, memref<16x16xi32, 2>) -> memref<2x16xi32, 2>
    adf.buffer.location(%32, %c24, %c2, %c16384, %c24576) : (memref<2x16xi32, 2>, index, index, index, index)
    adf.buffer.location(%15, %c24, %c2, %c0, %c8192) : (memref<8x16xi32, 2>, index, index, index, index)
    adf.buffer.location(%16, %c24, %c3, %c16384, %c24576) : (memref<16x16xi32, 2>, index, index, index, index)
    adf.buffer.location(%14, %c24, %c3, %c0, %c8192) : (memref<2x8x16xi32, 2>, index, index, index, index)
    adf.connect(%32, %20) : (memref<2x16xi32, 2>, memref<2x16xi32, 2>)
    adf.connect(%arg11, %17) : (!adf.plio<In, 128>, memref<2x8x16xi32, 2>)
    adf.connect(%arg11, %24) : (!adf.plio<In, 128>, memref<2x8x16xi32, 2>)
    %33 = call @kernel_mttkrp(%17, %18, %19, %20) {adf.kernel, "col, row" = [24 : index, 3 : index], ivs = [1 : index, 0 : index, 1 : index], kernel_mttkrp = 5 : index} : (memref<2x8x16xi32, 2>, memref<8x16xi32, 2>, memref<16x16xi32, 2>, memref<2x16xi32, 2>) -> memref<2x16xi32, 2>
    adf.buffer.location(%33, %c25, %c3, %c4096, %c12288) : (memref<2x16xi32, 2>, index, index, index, index)
    adf.buffer.location(%18, %c25, %c3, %c16384, %c24576) : (memref<8x16xi32, 2>, index, index, index, index)
    adf.buffer.location(%19, %c25, %c3, %c0, %c8192) : (memref<16x16xi32, 2>, index, index, index, index)
    adf.buffer.location(%17, %c24, %c2, %c4096, %c12288) : (memref<2x8x16xi32, 2>, index, index, index, index)
    adf.connect(%33, %arg12) : (memref<2x16xi32, 2>, !adf.plio<Out, 128>)
    %34 = call @kernel_mttkrp0(%21, %22, %23) {adf.kernel, "col, row" = [24 : index, 6 : index], ivs = [0 : index, 1 : index, 1 : index], kernel = 0 : index, kernel_mttkrp0 = 6 : index} : (memref<2x8x16xi32, 2>, memref<8x16xi32, 2>, memref<16x16xi32, 2>) -> memref<2x16xi32, 2>
    adf.buffer.location(%34, %c24, %c6, %c16384, %c24576) : (memref<2x16xi32, 2>, index, index, index, index)
    adf.buffer.location(%22, %c24, %c6, %c0, %c8192) : (memref<8x16xi32, 2>, index, index, index, index)
    adf.buffer.location(%23, %c24, %c7, %c16384, %c24576) : (memref<16x16xi32, 2>, index, index, index, index)
    adf.buffer.location(%21, %c24, %c7, %c0, %c8192) : (memref<2x8x16xi32, 2>, index, index, index, index)
    adf.connect(%34, %27) : (memref<2x16xi32, 2>, memref<2x16xi32, 2>)
    %35 = call @kernel_mttkrp(%24, %25, %26, %27) {adf.kernel, "col, row" = [24 : index, 7 : index], ivs = [1 : index, 1 : index, 1 : index], kernel_mttkrp = 7 : index} : (memref<2x8x16xi32, 2>, memref<8x16xi32, 2>, memref<16x16xi32, 2>, memref<2x16xi32, 2>) -> memref<2x16xi32, 2>
    adf.buffer.location(%35, %c25, %c7, %c4096, %c12288) : (memref<2x16xi32, 2>, index, index, index, index)
    adf.buffer.location(%25, %c25, %c7, %c16384, %c24576) : (memref<8x16xi32, 2>, index, index, index, index)
    adf.buffer.location(%26, %c25, %c7, %c0, %c8192) : (memref<16x16xi32, 2>, index, index, index, index)
    adf.buffer.location(%24, %c24, %c6, %c4096, %c12288) : (memref<2x8x16xi32, 2>, index, index, index, index)
    adf.connect(%35, %arg13) : (memref<2x16xi32, 2>, !adf.plio<Out, 128>)
    return
  }
  ...
  func.func @load2(%arg0: memref<128x8xi512>, %arg1: memref<1xi512, "stream1">, %arg2: memref<1xi512, "stream1">, %arg3: memref<1xi512, "stream1">, %arg4: memref<1xi512, "stream1">) attributes {adf.pl, inline = false, load, mem_idx = [0 : i32], mem_type = [i32], template} {
    %c1 = arith.constant 1 : index
                  ...
                  affine.for %arg9 = 0 to 2 {
                    affine.for %arg10 = 0 to 2 {
                      affine.for %arg11 = 0 to 4 {
                        ...
                        affine.store %17, %alloc[%arg10 + %arg6 * 2, %arg11 + %arg7 * 4] : memref<4x8xi128, 1>
                      } {pipeline_ii = 1 : index}
                    }
                  }
                }
  ...
  func.func @store0(%arg0: memref<8x8xi512>, %arg1: memref<1xi512, "stream1">, %arg2: memref<1xi512, "stream1">, %arg3: memref<1xi512, "stream1">, %arg4: memref<1xi512, "stream1">) attributes {adf.pl, inline = false, mem_idx = [0 : i32], mem_type = [i32], store, template} {
    %c1 = arith.constant 1 : index
    affine.for %arg5 = 0 to 1 {
      affine.for %arg6 = 0 to 2 {
        affine.for %arg7 = 0 to 2 {
  ...
  func.func @load0(%arg0: memref<8x32x8xi512>, %arg1: memref<1xi512, "stream1">, %arg2: memref<1xi512, "stream1">, %arg3: memref<1xi512, "stream1">, %arg4: memref<1xi512, "stream1">) attributes {adf.pl, inline = false, load, mem_idx = [0 : i32], mem_type = [i32], template} {
    %c1 = arith.constant 1 : index
    affine.for %arg5 = 0 to 1 {
      affine.for %arg6 = 0 to 2 {
        affine.for %arg7 = 0 to 2 {
  ...
  func.func @load1(%arg0: memref<32x8xi512>, %arg1: memref<1xi512, "stream1">, %arg2: memref<1xi512, "stream1">) attributes {adf.pl, inline = false, load, mem_idx = [0 : i32], mem_type = [i32], template} {
    %c1 = arith.constant 1 : index
  ...
  func.func private @mttkrp_host(memref<8x32x128xi32>, memref<32x128xi32>, memref<128x128xi32>, memref<8x128xi32>) attributes {origin_func = "mttkrp"}
  func.func @top_host(%arg0: memref<8x32x128xi32>, %arg1: memref<32x128xi32>, %arg2: memref<128x128xi32>, %arg3: memref<8x128xi32>) attributes {origin_func = "top", outArgs = [3 : i32], top_host} {
    call @mttkrp_host(%arg0, %arg1, %arg2, %arg3) {origin_func = "mttkrp"} : (memref<8x32x128xi32>, memref<32x128xi32>, memref<128x128xi32>, memref<8x128xi32>) -> ()
    return
  }
}
