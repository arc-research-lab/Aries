...
@task_tile(False) # Disable running ARIES on CPU
...
prj_dir= cur_dir + '/my_project_large'
...
sch.parallel(gemm_task, [11, 8, 4]) # AIE Array Parallelism
sch.l2buffer(gemm_task, [4, 6, 1]) # L2 buffer data reuse
