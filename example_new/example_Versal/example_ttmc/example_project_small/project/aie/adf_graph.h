...
public:
  ...
  adf_cell0() {
    ...
    adf::location<kernel>(kernel_ttmc0_k0) = adf::tile(24, 0);
    adf::location<stack>(kernel_ttmc0_k0) = adf::bank(24, 0, 3);
    kernel_ttmc_k1 = adf::kernel::create(kernel_ttmc);
    adf::source(kernel_ttmc_k1) = "kernel_ttmc.cc";
    adf::runtime<ratio>(kernel_ttmc_k1) = 1;
    adf::location<kernel>(kernel_ttmc_k1) = adf::tile(24, 1);
    adf::location<stack>(kernel_ttmc_k1) = adf::bank(24, 1, 3);
    ...
    adf::location<kernel>(kernel_ttmc0_k2) = adf::tile(24, 4);
    adf::location<stack>(kernel_ttmc0_k2) = adf::bank(24, 4, 3);
    kernel_ttmc_k3 = adf::kernel::create(kernel_ttmc);
    adf::source(kernel_ttmc_k3) = "kernel_ttmc.cc";
    adf::runtime<ratio>(kernel_ttmc_k3) = 1;
    adf::location<kernel>(kernel_ttmc_k3) = adf::tile(24, 5);
    adf::location<stack>(kernel_ttmc_k3) = adf::bank(24, 5, 3);
    ...
    adf::location<kernel>(kernel_ttmc0_k4) = adf::tile(24, 2);
    adf::location<stack>(kernel_ttmc0_k4) = adf::bank(24, 2, 3);
    kernel_ttmc_k5 = adf::kernel::create(kernel_ttmc);
    adf::source(kernel_ttmc_k5) = "kernel_ttmc.cc";
    adf::runtime<ratio>(kernel_ttmc_k5) = 1;
    adf::location<kernel>(kernel_ttmc_k5) = adf::tile(24, 3);
    adf::location<stack>(kernel_ttmc_k5) = adf::bank(24, 3, 3);
    ...
    adf::location<kernel>(kernel_ttmc0_k6) = adf::tile(24, 6);
    adf::location<stack>(kernel_ttmc0_k6) = adf::bank(24, 6, 3);
    kernel_ttmc_k7 = adf::kernel::create(kernel_ttmc);
    adf::source(kernel_ttmc_k7) = "kernel_ttmc.cc";
    adf::runtime<ratio>(kernel_ttmc_k7) = 1;
    adf::location<kernel>(kernel_ttmc_k7) = adf::tile(24, 7);
    adf::location<stack>(kernel_ttmc_k7) = adf::bank(24, 7, 3);
    ...
    adf::location<PLIO>(v8) = shim(24, 2);
    v9 = adf::input_plio::create("v9", plio_128_bits, "data/v9.txt", 250);
    adf::location<PLIO>(v9) = shim(22, 2);
    ...
    adf::location<PLIO>(v11) = shim(23, 4);
    ...
    adf::connect<>(v2.out[0], kernel_ttmc0_k4.in[2]);
    ...
    adf::connect<>(v4.out[0], kernel_ttmc_k5.in[2]);
    ...
    adf::connect<>(v6.out[0], kernel_ttmc0_k6.in[2]);
    ...
    adf::connect<>(v7.out[0], kernel_ttmc_k7.in[2]);
    ...
    adf::connect<>(v9.out[0], kernel_ttmc0_k4.in[1]);
    adf::connect<>(v9.out[0], kernel_ttmc_k5.in[1]);
    adf::connect<>(v9.out[0], kernel_ttmc0_k6.in[1]);
    adf::connect<>(v9.out[0], kernel_ttmc_k7.in[1]);
