...
int main(int argc, char **argv) {
  ...
  auto in_bohdl0 = xrt::bo(device, 8192 * sizeof(int32_t), top_0.group_id(0));
  ...
  memcpy(in_bomapped0, srcVec0.data(), srcVec0.size() * sizeof(int32_t));  in_bohdl0.sync(XCL_BO_SYNC_BO_TO_DEVICE, 8192 * sizeof(int32_t), 0);
  ...
  auto in_bohdl1 = xrt::bo(device, 2048 * sizeof(int32_t), top_0.group_id(0));
  ...
  memcpy(in_bomapped1, srcVec1.data(), srcVec1.size() * sizeof(int32_t));  in_bohdl1.sync(XCL_BO_SYNC_BO_TO_DEVICE, 2048 * sizeof(int32_t), 0);
  ...
  auto in_bohdl2 = xrt::bo(device, 8192 * sizeof(int32_t), top_0.group_id(0));
  ...
  memcpy(in_bomapped2, srcVec2.data(), srcVec2.size() * sizeof(int32_t));  in_bohdl2.sync(XCL_BO_SYNC_BO_TO_DEVICE, 8192 * sizeof(int32_t), 0);
  ...
  auto out_bohdl0 = xrt::bo(device, 8192 * sizeof(int32_t), top_0.group_id(0));
  ...
  out_bohdl0.sync(XCL_BO_SYNC_BO_FROM_DEVICE , 8192 * sizeof(int32_t), 0);
