...
int main(int argc, char **argv) {
  ...
  auto in_bohdl0 = xrt::bo(device, 8192 * sizeof(float), top_0.group_id(0));
  ...
  memcpy(in_bomapped0, srcVec0.data(), srcVec0.size() * sizeof(float));  in_bohdl0.sync(XCL_BO_SYNC_BO_TO_DEVICE, 8192 * sizeof(float), 0);
