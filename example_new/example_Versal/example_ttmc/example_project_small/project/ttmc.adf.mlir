...
module {
    ...
    affine.for %arg2 = 0 to 4 {
      affine.for %arg3 = 0 to 32 {
        affine.for %arg4 = 0 to 8 {
          affine.store %c0_i128, %alloc[%arg2, %arg3, %arg4] : memref<4x32x8xi128, 1>
        } {pipeline_ii = 1 : index}
      }
    }
    affine.for %arg2 = 0 to 1 {
                        ...
                        affine.for %arg12 = 0 to 2 {
                          affine.for %arg13 = 0 to 16 {
                            affine.for %arg14 = 0 to 4 {
                              ...
                              %1 = affine.load %alloc[%arg12 + %arg7 * 2, %arg13 + %arg8 * 16, %arg14 + %arg9 * 4] : memref<4x32x8xi128, 1>
                              ...
                              affine.store %29, %alloc[%arg12 + %arg7 * 2, %arg13 + %arg8 * 16, %arg14 + %arg9 * 4] : memref<4x32x8xi128, 1>
                            } {pipeline_ii = 1 : index}
                          }
                        }
                      }
                ...
                affine.for %arg8 = 0 to 16 {
                  affine.for %arg9 = 0 to 2 {
                    affine.for %arg10 = 0 to 4 {
                      %0 = affine.load %alloc[%arg7 + %arg5 * 2, %arg8 + %arg6 * 16, %arg10 + %arg9 * 4] : memref<4x32x8xi128, 1>
                      affine.store %0, %arg1[0] : memref<1xi128, "stream">
                      affine.store %c0_i128, %alloc[%arg7 + %arg5 * 2, %arg8 + %arg6 * 16, %arg10 + %arg9 * 4] : memref<4x32x8xi128, 1>
                    } {pipeline_ii = 1 : index}
                  }
                }
              }
                ...
                affine.for %arg11 = 0 to 16 {
                  affine.for %arg12 = 0 to 2 {
                    affine.for %arg13 = 0 to 2 {
                      ...
                      affine.store %1, %arg0[%arg10 + %arg8 * 2 + %arg5 * 4, %arg11 + %arg9 * 32 + %arg6 * 64, %arg13 + %arg12 * 2 + %arg7 * 4] : memref<4x64x4xi512>
                    } {pipeline_ii = 1 : index}
                  }
                }
              }
                ...
                affine.for %arg11 = 0 to 16 {
                  affine.for %arg12 = 0 to 2 {
                    affine.for %arg13 = 0 to 2 {
                      ...
                      affine.store %1, %arg0[%arg10 + %arg8 * 2 + %arg5 * 4, %arg11 + %arg9 * 32 + %arg6 * 64 + 16, %arg13 + %arg12 * 2 + %arg7 * 4] : memref<4x64x4xi512>
                    } {pipeline_ii = 1 : index}
                  }
                }
              }
  ...
  func.func @ttmc_pl(%arg0: memref<4x16x8xi512>, %arg1: memref<16x4xi512>, %arg2: memref<128x4xi512>, %arg3: memref<4x64x4xi512>, %arg4: memref<1xi128, "plio">, %arg5: memref<1xi128, "plio">, %arg6: memref<1xi128, "plio">, %arg7: memref<1xi128, "plio">, %arg8: memref<1xi128, "plio">, %arg9: memref<1xi128, "plio">, %arg10: memref<1xi128, "plio">, %arg11: memref<1xi128, "plio">, %arg12: memref<1xi128, "plio">, %arg13: memref<1xi128, "plio">, %arg14: memref<1xi128, "plio">, %arg15: memref<1xi128, "plio">) attributes {adf.pl = true, dataflow, inline = false, mem_idx = [0 : i32, 1 : i32, 2 : i32, 3 : i32], mem_type = [f32, f32, f32, f32]} {
    ...
    %alloc_11 = memref.alloc() {buffer_type = "bram_s2p"} : memref<4x32x8xi128, 1>
    affine.for %arg16 = 0 to 4 {
      affine.for %arg17 = 0 to 32 {
        affine.for %arg18 = 0 to 8 {
          affine.store %c0_i128, %alloc_11[%arg16, %arg17, %arg18] : memref<4x32x8xi128, 1>
        } {pipeline_ii = 1 : index}
      }
    }
    %alloc_12 = memref.alloc() {buffer_type = "bram_s2p"} : memref<4x32x8xi128, 1>
    affine.for %arg16 = 0 to 4 {
      affine.for %arg17 = 0 to 32 {
        affine.for %arg18 = 0 to 8 {
          affine.store %c0_i128, %alloc_12[%arg16, %arg17, %arg18] : memref<4x32x8xi128, 1>
        } {pipeline_ii = 1 : index}
      }
    }
    %alloc_13 = memref.alloc() {buffer_type = "bram_s2p"} : memref<4x32x8xi128, 1>
    affine.for %arg16 = 0 to 4 {
      affine.for %arg17 = 0 to 32 {
        affine.for %arg18 = 0 to 8 {
          affine.store %c0_i128, %alloc_13[%arg16, %arg17, %arg18] : memref<4x32x8xi128, 1>
        } {pipeline_ii = 1 : index}
      }
    }
    %alloc_14 = memref.alloc() {buffer_type = "bram_s2p"} : memref<4x32x8xi128, 1>
    affine.for %arg16 = 0 to 4 {
      affine.for %arg17 = 0 to 32 {
        affine.for %arg18 = 0 to 8 {
          affine.store %c0_i128, %alloc_14[%arg16, %arg17, %arg18] : memref<4x32x8xi128, 1>
        } {pipeline_ii = 1 : index}
      }
    }
    ...
    call @send3_top(%arg9, %alloc_7, %arg13, %alloc_10) : (memref<1xi128, "plio">, memref<1xi128, "stream">, memref<1xi128, "plio">, memref<1xi128, "stream">) -> ()
    call @load2_top(%arg2, %alloc_17, %alloc_16, %alloc_15, %alloc_18) : (memref<128x4xi512>, memref<1xi512, "stream1">, memref<1xi512, "stream1">, memref<1xi512, "stream1">, memref<1xi512, "stream1">) -> ()
    ...
    call @send5_top(%arg12, %alloc_5, %arg14, %alloc_4, %arg15, %alloc_6, %arg5, %alloc_8) : (memref<1xi128, "plio">, memref<1xi128, "stream">, memref<1xi128, "plio">, memref<1xi128, "stream">, memref<1xi128, "plio">, memref<1xi128, "stream">, memref<1xi128, "plio">, memref<1xi128, "stream">) -> ()
    call @send1_top(%arg11, %alloc_9, %arg4, %alloc_3) : (memref<1xi128, "plio">, memref<1xi128, "stream">, memref<1xi128, "plio">, memref<1xi128, "stream">) -> ()
    call @receive2_top(%arg8, %alloc_1, %arg6, %alloc, %arg10, %alloc_2, %arg7, %alloc_0) : (memref<1xi128, "plio">, memref<1xi128, "stream">, memref<1xi128, "plio">, memref<1xi128, "stream">, memref<1xi128, "plio">, memref<1xi128, "stream">, memref<1xi128, "plio">, memref<1xi128, "stream">) -> ()
    ...
    call @store0_top(%arg3, %alloc_21, %alloc_22, %alloc_20, %alloc_19) : (memref<4x64x4xi512>, memref<1xi512, "stream1">, memref<1xi512, "stream1">, memref<1xi512, "stream1">, memref<1xi512, "stream1">) -> ()
  ...
  func.func @ttmc(%arg0: memref<4x16x8xi512>, %arg1: memref<16x4xi512>, %arg2: memref<128x4xi512>, %arg3: memref<4x64x4xi512>, %arg4: memref<1xi128, "plio">, %arg5: memref<1xi128, "plio">, %arg6: memref<1xi128, "plio">, %arg7: memref<1xi128, "plio">, %arg8: memref<1xi128, "plio">, %arg9: memref<1xi128, "plio">, %arg10: memref<1xi128, "plio">, %arg11: memref<1xi128, "plio">, %arg12: memref<1xi128, "plio">, %arg13: memref<1xi128, "plio">, %arg14: memref<1xi128, "plio">, %arg15: memref<1xi128, "plio">) attributes {adf.func, mem_idx = [0 : i32, 1 : i32, 2 : i32, 3 : i32], mem_type = [f32, f32, f32, f32], plio = true} {
    ...
    adf.connect(%arg14, %4) {top_config} : (memref<1xi128, "plio">, !adf.plio<In, 128>)
    ...
    adf.connect(%6, %arg6) {top_config} : (!adf.plio<Out, 128>, memref<1xi128, "plio">)
    ...
    adf.connect(%arg5, %9) {top_config} : (memref<1xi128, "plio">, !adf.plio<In, 128>)
