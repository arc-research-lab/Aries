...
module {
  func.func @kernel_ttmc(%TileA: memref<2x8x32xf32, 2>, %TileB: memref<8x16xf32, 2>, %TileC: memref<32x16xf32, 2>, %TileD: memref<2x16x16xf32, 2>) attributes {adf.kernel} {
        ...
        affine.for %k0 = 0 to 16 {
          ...
          affine.for %l0 = 0 to 8 {
            affine.for %m0 = 0 to 32 {
              %v0 = affine.load %TileA[%i0, %l0, %m0] : memref<2x8x32xf32, 2>
              %v1 = affine.load %TileB[%l0, %j0] : memref<8x16xf32, 2>
  ...
  func.func @ttmc(%A: memref<2x32x128xf32>, %B: memref<32x64xf32>, %C: memref<128x64xf32>, %D: memref<2x64x64xf32>) attributes {adf.func} {
    affine.for %i = 0 to 1 {
      affine.for %j = 0 to 4 {
        affine.for %k = 0 to 4 {
          affine.for %l = 0 to 4 {
            affine.for %m = 0 to 4 {
              %L1_A = adf.buffer.create @L1_L1_A() : memref<2x8x32xf32, 2>
              %L1_B = adf.buffer.create @L1_L1_B() : memref<8x16xf32, 2>
              ...
              adf.dma(%A[%v0 ,%v1 ,%v2] [%cti_size ,%ctl_size ,%ctm_size] [%cti_stride ,%ctl_stride ,%ctm_stride] [] [] [] [], %L1_A[] [] [] [] [] [] []) : (memref<2x32x128xf32> , memref<2x8x32xf32, 2>)
              ...
              adf.dma(%B[%v3 ,%v4] [%ctl_size_1 ,%ctj_size] [%ctl_stride_1 ,%ctj_stride] [] [] [] [], %L1_B[] [] [] [] [] [] []) : (memref<32x64xf32> , memref<8x16xf32, 2>)
              ...
              func.call @kernel_ttmc(%L1_A, %L1_B, %L1_C, %L1_D) : (memref<2x8x32xf32, 2>, memref<8x16xf32, 2>, memref<32x16xf32, 2>, memref<2x16x16xf32, 2>) -> ()
              ...
              adf.dma(%L1_D[] [] [] [] [] [] [], %D[%v7 ,%v8 ,%v9] [%cti_size_1 ,%ctj_size_1 ,%ctk_size_1] [%cti_stride_1 ,%ctj_stride_1 ,%ctk_stride_1] [] [] [] []) {accumulator} : (memref<2x16x16xf32, 2> , memref<2x64x64xf32>)
            }
          }
        }
      }
  ...
  func.func @top(%A: memref<2x32x128xf32>, %B: memref<32x64xf32>, %C: memref<128x64xf32>, %D: memref<2x64x64xf32>) attributes {top_func} {
    func.call @ttmc(%A, %B, %C, %D) : (memref<2x32x128xf32>, memref<32x64xf32>, memref<128x64xf32>, memref<2x64x64xf32>) -> ()
    return
  } 
}
