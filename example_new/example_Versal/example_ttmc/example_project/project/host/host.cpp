...
int main(int argc, char **argv) {
  ...
  auto in_bohdl0 = xrt::bo(device, 16384 * sizeof(float), top_0.group_id(0));
  ...
  memcpy(in_bomapped0, srcVec0.data(), srcVec0.size() * sizeof(float));  in_bohdl0.sync(XCL_BO_SYNC_BO_TO_DEVICE, 16384 * sizeof(float), 0);
  ...
  auto in_bohdl1 = xrt::bo(device, 512 * sizeof(float), top_0.group_id(0));
  ...
  memcpy(in_bomapped1, srcVec1.data(), srcVec1.size() * sizeof(float));  in_bohdl1.sync(XCL_BO_SYNC_BO_TO_DEVICE, 512 * sizeof(float), 0);
